...
struct  AudioRolloffMode_t1562508899 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AudioRolloffMode_t1562508899, ___value___1)); }
