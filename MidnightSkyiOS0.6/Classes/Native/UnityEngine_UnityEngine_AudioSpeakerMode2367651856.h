...
struct  AudioSpeakerMode_t2367651856 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AudioSpeakerMode_t2367651856, ___value___1)); }
