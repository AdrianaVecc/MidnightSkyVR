...
struct  AudioSourceCurveType_t4185881660 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AudioSourceCurveType_t4185881660, ___value___1)); }
