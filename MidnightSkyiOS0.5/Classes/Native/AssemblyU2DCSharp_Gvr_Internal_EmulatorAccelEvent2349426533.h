...
struct  EmulatorAccelEvent_t2349426533 
{
public:
...
public:
	inline static int32_t get_offset_of_timestamp_0() { return static_cast<int32_t>(offsetof(EmulatorAccelEvent_t2349426533, ___timestamp_0)); }
	...
	inline static int32_t get_offset_of_value_1() { return static_cast<int32_t>(offsetof(EmulatorAccelEvent_t2349426533, ___value_1)); }
...
struct EmulatorAccelEvent_t2349426533_marshaled_pinvoke
{
	int64_t ___timestamp_0;
	Vector3_t4282066566_marshaled_pinvoke ___value_1;
};
// Native definition for marshalling of: Gvr.Internal.EmulatorAccelEvent
struct EmulatorAccelEvent_t2349426533_marshaled_com
{
	int64_t ___timestamp_0;
